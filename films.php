...
<div class="watchlist">
    <div class="wl-title">
        можно посмотреть:<br><span>из категории фильмы</span>
    </div>
    ...
    <?php $result = $mysqli->query("SELECT * FROM `films` WHERE  id='$i'"); while($row = mysqli_fetch_assoc($result)) { $type= $row['type']; $id=$row['id']; }; if ($type=='фильм'){?>
    ...
    <div class="big-items-column">
        <div class="big-item-column">
            ...
            <div class="big-type-movie">фильм</div>
